...
export default function SwapInterface() {
  const { stxAddress, isConnected, connectWallet, balance: walletBalance } = useStacksWallet();
  const {
    isSwapping,
    error: swapError,
    txId,
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 py-12">
      <div className="max-w-lg mx-auto px-4">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Trade tokens instantly on Stacks</p>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/10">
          ...
          {!isConnected ? (
            <button
              ...
              className="w-full bg-gradient-to-r from-blue-600 to-blue-400 hover:from-blue-700 hover:to-blue-700 text-white py-4 rounded-xl font-bold transition-all"
            >
              Connect Wallet
            </button>
          ) : (
